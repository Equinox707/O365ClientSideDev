<%@ Assembly Name="JSOMBasics, Version=1.0.0.0, Culture=neutral, PublicKeyToken=0dd4e46d8ca3bf3c" %>
...
<asp:Content ID="PageHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script type="text/javascript" src="/_layouts/15/sp.js"></script>
     <SharePoint:ScriptLink ID="static" Name="JSOMBasics/usingJSOM.js" Localizable="False" runat="server" >
    </SharePoint:ScriptLink>
</asp:Content>
